...
description: Use when making plugin behavior configurable. Triggers on "plugin settings", "user-configurable plugin", ".local.md files", "plugin state files", "per-project plugin settings".
version: 0.1.0
---
