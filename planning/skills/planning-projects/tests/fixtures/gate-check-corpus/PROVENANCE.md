...
Load-bearing detail: **INSTANCE-SHAPED checks occur in only two plans of the whole
corpus** — the i18n and plan-format-tiering ones, contributing 1 and 2 respectively. Drop
either and that class falls toward zero, which is why both are here despite the overlap in
what they otherwise cover. The `backlog-bl020-bl027` plan supplies the JUDGMENT and bulk
EXECUTABLE counts.
